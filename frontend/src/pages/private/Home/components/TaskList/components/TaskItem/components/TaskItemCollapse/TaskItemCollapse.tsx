...
const TaskItemCollapse: React.FC<ITaskItemCollapseProps> = ({ task, expanded }) => {
  return (
    <Collapse in={expanded} timeout='auto' unmountOnExit>
      <Box display='flex' flexWrap='wrap' gap='20px' marginTop='20px'>
        <Box display='flex' flexDirection='column' gap='5px' flex='1' minWidth="100px">
        ...
        {task.description && (
          <Box width='100%' display='flex' flexDirection='column' gap='5px'>
            ...
            <Typography variant='body1' component='p' sx={{ wordWrap: "break-word" }}>
              {task.description}
            </Typography>
          </Box>
        )}
